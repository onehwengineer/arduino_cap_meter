 ...
 */
const int SHOW_MOISTURE_PERC = 0; // Selector to display moisture in %
const int SENSOR_READ_INTERVAL_SEC = 5; // How often sensor is read, in sec
